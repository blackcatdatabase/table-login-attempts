...
{
    public function name(): string { return 'table-login_attempts'; }
    public function table(): string { return 'login_attempts'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-auth_events', 'table-users' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_login_attempted_at', 'idx_login_ip_success_time', 'idx_login_user_time', 'idx_login_username_hash' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_login_attempts_auth_event', 'fk_login_attempts_user' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_login_attempted_at', 'idx_login_ip_success_time', 'idx_login_user_time', 'idx_login_username_hash' ],
