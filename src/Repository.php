...
use BlackCat\Database\Packages\LoginAttempts\Repository\LoginAttemptRepositoryInterface;
use BlackCat\Database\Packages\LoginAttempts\Repository\LoginAttemptRepository as GeneratedRepository;
...
{
  private LoginAttemptRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof LoginAttemptRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected LoginAttemptRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\LoginAttempts\Dto\LoginAttemptDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\LoginAttempts\Dto\LoginAttemptDto|null { return $this->repo->getById($id, $asDto); }
