...
final class Repository
{
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\LoginAttempts\Dto\LoginAttemptDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\LoginAttempts\Dto\LoginAttemptDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\LoginAttempts\Dto\LoginAttemptDto|null
    {
