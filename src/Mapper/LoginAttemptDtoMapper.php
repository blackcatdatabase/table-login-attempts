...
namespace BlackCat\Database\Packages\LoginAttempts\Mapper;

use BlackCat\Database\Packages\LoginAttempts\Dto\LoginAttemptDto;
use BlackCat\Database\Packages\LoginAttempts\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO LoginAttemptDto:
...
final class LoginAttemptDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'id' => 'id', 'ip_hash' => 'ipHash', 'ip_hash_key_version' => 'ipHashKeyVersion', 'attempted_at' => 'attemptedAt', 'success' => 'success', 'user_id' => 'userId', 'username_hash' => 'usernameHash', 'username_hash_key_version' => 'usernameHashKeyVersion', 'auth_event_id' => 'authEventId' ];

    /** @var string[] */
    private const BOOL_COLS   = [ 'success' ];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'user_id', 'auth_event_id' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'attempted_at' ];
    /** @var string[] */
    private const BIN_COLS    = [ 'ip_hash', 'username_hash' ];
     ...
     */
    public static function fromRow(array $row): LoginAttemptDto
    {
        /** @var LoginAttemptDto */
        return DtoHydrator::fromRow(
            LoginAttemptDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?LoginAttemptDto
    {
     ...
     *
     * @param LoginAttemptDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(LoginAttemptDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(LoginAttemptDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(LoginAttemptDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,LoginAttemptDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,LoginAttemptDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(LoginAttemptDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,LoginAttemptDto>
     */
