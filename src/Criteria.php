 ...
 * - whitelist filtrů: [ 'id', 'ip_hash', 'attempted_at', 'success', 'user_id', 'username_hash', 'auth_event_id' ]
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'id', 'ip_hash', 'attempted_at', 'success', 'user_id', 'username_hash', 'auth_event_id' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'ip_hash', 'attempted_at', 'success', 'user_id', 'username_hash', 'auth_event_id' ], true);
            $parts = [];
