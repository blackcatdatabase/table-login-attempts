...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 2 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 2 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\login-attempts](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\login-attempts)
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package login-attempts -Apply
